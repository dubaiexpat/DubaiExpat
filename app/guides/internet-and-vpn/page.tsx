        ...
        <section className="px-4 py-12 md:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="mt-6">
                There are good alternatives &mdash; ExpressVPN, Surfshark and Proton VPN all have genuine merits &mdash; but when we looked at price versus reliability in the UAE specifically, NordVPN was the provider we kept coming back to. At the time of writing, their two-year plan is roughly &pound;2.50 per month on the standard tier and under &pound;4 on the plus tier that bundles their password manager and data breach scanner.
              </p>
              <div className="mt-6">
                <a
                  href={NORD_FEATURES}
