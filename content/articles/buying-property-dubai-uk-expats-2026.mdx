...
meta_title: "Buying Property in Dubai 2026: UK Expat Guide to Freehold, Mortgages & Costs"
meta_description: "How UK expats actually buy property in Dubai in 2026 — freehold zones, mortgage rules (LTV 50-80%), DLD 4% transfer fee, off-plan vs ready trade-offs, and the contract clauses that catch UK buyers out."
...
For Golden Visa eligibility (≥ AED 2M property), only the *paid-up equity* counts — so a 75% mortgage means AED 500k of own funds, which doesn't qualify for the property route. Either pay AED 2M+ in cash, or buy a higher-value property where 25% down still exceeds AED 2M (so a AED 8M+ purchase with 75% mortgage). See our [Golden Visa pathways article](/articles/dubai-golden-visa-pathways-uk-expats-2026) for the qualification details.
